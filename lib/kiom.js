...
export default {
    ...
    out(idx){
          ...
          if(this.OR) str.push('  OR: ' + this.outValue(this.OR));
    ...
    setAcupoint(arrayKey,keywordArray){
      if(!this.other['general']['acupoint']){
        ...
        if(keywordArray[1])arrKWD["acupoint"][key].push("\""+keywordArray[1]+"\"");
        if(keywordArray[0].length>0)arrKWD["acupoint"]["acupoint_keyword"].push("\""+keywordArray[0]+"\"");
        this.other['general']["acupoint"]=arrKWD;
    },
    ...
    setEtc(arrayKey,keywordArray){
      if(!this.other['general']['etc']){
        ...
        if(keywordArray[1])arrKWD["etc"][key].push("\""+keywordArray[1]+"\"");
        if(keywordArray[0].length){
          for(var i=0;i<keywordArray[0].length;i++){
            arrKWD["etc"]["etc_keyword"].push("\""+keywordArray[0][i]+"\"");
          }
        }
        this.other["general"]["etc"]=arrKWD;
    },
    ...
    setGeneral(arrayKey,keywordArray){
      if(!this.other['general']['disease']){
        ...
        if(keywordArray[1])arrKWD["disease"][key].push("\""+keywordArray[1]+"\"");
        if(keywordArray[0].length){
          for(var i=0;i<keywordArray[0].length;i++){
            arrKWD["disease"]["disease_keyword"].push("\""+keywordArray[0][i]+"\"");
          }
        }
        this.other["general"]["disease"]=arrKWD;
    },
    ...
    setHerbs(arrayKey,keywordArray){
      if(!this.other["general"]['herbs']){
        ...
        if(keywordArray[1])arrKWD["herbs"][key].push("\""+keywordArray[1]+"\"");
        if(keywordArray[0].length){
          for(var i=0;i<keywordArray[0].length;i++){
            arrKWD["herbs"]["herbs_keyword"].push("\""+keywordArray[0][i]+"\"");
          }
        }
        this.other["general"]["herbs"]=arrKWD;
    },
    ...
    setPrescription(arrayKey,keywordArray){
      if(!this.other["general"]['prescription']){
        ...
        if(keywordArray[1])arrKWD["prescription"][key].push("\""+keywordArray[1]+"\"");
        if(keywordArray[0])arrKWD["prescription"]["prescription_keyword"].push("\""+keywordArray[0]+"\"");
        this.other["general"]["prescription"]=arrKWD;
    },
