  ...
  toggle() {
      ...
      for(var i=0;i<testData.length;i++){
        ...
        if(testData[i].trim() != ""){
            ...
            var tagname=kiom.tagName;
            if(tagname.indexOf("h") != -1){
                var str = tagname.indexOf("h");
                var idx = tagname.substr(str+1,1);
                pTag="p"+idx;
                imgTag="img"+idx;
            }
            if(tagname.indexOf("h") == -1 && tagname.indexOf("p") != -1){
              kiom.tagName = pTag;
            }
            if(tagname.indexOf("h") == -1 && tagname.indexOf("img") != -1){
              kiom.tagName = imgTag;
            }
